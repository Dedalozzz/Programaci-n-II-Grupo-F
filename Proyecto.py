...
def nuevoPaciente():
    ...
    ventanaRegistro.configure(bg="#800020")  # Rojo vino
    #nombre
    nombreLabel=tk.Label(ventanaRegistro,text="Nombre:",bg="#800020", fg="white", font=("Times New Roman", 12))
    nombreLabel.grid(row=0,column=0,padx=10,pady=5,sticky="n")
    entryNombre=tk.Entry(ventanaRegistro, font=("Times New Roman", 12))
    entryNombre.grid(row=0,column=1,padx=10,pady=5,sticky="we")
    #Direccion
    direccionLabel=tk.Label(ventanaRegistro,text="Direccion:",bg="#800020", fg="white", font=("Times New Roman", 12))
    direccionLabel.grid(row=1,column=0,padx=10,pady=5,sticky="n")
    entryDireccion=tk.Entry(ventanaRegistro, font=("Times New Roman", 12))
    entryDireccion.grid(row=1, column=1,padx=10,pady=5,sticky="we")
    #Telefono
    telefonoLabel=tk.Label(ventanaRegistro,text="Telefono:",bg="#800020", fg="white", font=("Times New Roman", 12))
    telefonoLabel.grid(row=2,column=0,padx=10,pady=5,sticky="n")
    entryTelefono=tk.Entry(ventanaRegistro, font=("Times New Roman", 12))
    entryTelefono.grid(row=2,column=1,padx=10,pady=5,sticky="we")
    #enfermedades base(checkbutton)
    enfLabel=tk.Label(ventanaRegistro,text="Enfermedades base:",bg="#800020", fg="white", font=("Times New Roman", 12))
    ...
    cbDiabetes=tk.Checkbutton(ventanaRegistro,text="Diabetes",variable=diabetes, bg="#800020", fg="white", font=("Times New Roman", 12), selectcolor="#800020")
    cbDiabetes.grid(row=6,column=0,columnspan=2,sticky="w", padx=20)
    cbHipertension=tk.Checkbutton(ventanaRegistro,text="Hipertension",variable=hipertension, bg="#800020", fg="white", font=("Times New Roman", 12), selectcolor="#800020")
    cbHipertension.grid(row=7,column=0,columnspan=2,sticky="w", padx=20)
    cbAsma=tk.Checkbutton(ventanaRegistro,text="Asma",variable=asma, bg="#800020", fg="white", font=("Times New Roman", 12), selectcolor="#800020")
    cbAsma.grid(row=8,column=0,columnspan=2,sticky="w", padx=20)
    #sexo (radiobutton)
    sexoLabel=tk.Label(ventanaRegistro,text="Sexo:",bg="#800020", fg="white", font=("Times New Roman", 12))
    sexoLabel.grid(row=3,column=0,padx=10,pady=5,sticky="n")
    sexo=tk.StringVar(value="Masculino")        # Valor inicial seleccionado
    rbMasculino=tk.Radiobutton(ventanaRegistro,text="Masculino",variable=sexo,value="Masculino", bg="#800020", fg="white", font=("Times New Roman", 12), selectcolor="#800020")
    rbMasculino.grid(row=3,column=1,sticky="n")
    rbFemenino=tk.Radiobutton(ventanaRegistro,text="Femenino",variable=sexo, value="Femenino", bg="#800020", fg="white", font=("Times New Roman", 12), selectcolor="#800020")
...
#a la altura de info colocar
    ...
    btnRegsitrar=tk.Button(ventanaRegistro,text="Registrar datos",command=registrarDatos, font=("Times New Roman", 12), bg="white", fg="black")
...
def nuevoDoctor():
    ...
    ventanaRegDoc.configure(bg="#800020")  # Rojo vino
    #nombre 
    nombreLabel=tk.Label(ventanaRegDoc,text="Nombre:",bg="#800020", fg="white", font=("Times New Roman", 12)) 
    nombreLabel.grid(row=0,column=0,padx=10,pady=5,sticky="n") 
    entryNombre=tk.Entry(ventanaRegDoc, font=("Times New Roman", 12)) 
    entryNombre.grid(row=0,column=1,padx=10,pady=5,sticky="we") 
    #Direccion 
    direccionLabel=tk.Label(ventanaRegDoc,text="Direccion:",bg="#800020", fg="white", font=("Times New Roman", 12)) 
    direccionLabel.grid(row=1,column=0,padx=10,pady=5,sticky="n") 
    entryDireccion=tk.Entry(ventanaRegDoc, font=("Times New Roman", 12)) 
    entryDireccion.grid(row=1, column=1,padx=10,pady=5,sticky="we") 
    #Telefono 
    telefonoLabel=tk.Label(ventanaRegDoc,text="Telefono:",bg="#800020", fg="white", font=("Times New Roman", 12)) 
    telefonoLabel.grid(row=2,column=0,padx=10,pady=5,sticky="n") 
    entryTelefono=tk.Entry(ventanaRegDoc, font=("Times New Roman", 12)) 
    entryTelefono.grid(row=2,column=1,padx=10,pady=5,sticky="we") 
    #sexo (radiobutton) 
    sexoLabel=tk.Label(ventanaRegDoc,text="Sexo:",bg="#800020", fg="white", font=("Times New Roman", 12)) 
    sexoLabel.grid(row=3,column=0,padx=10,pady=5,sticky="n") 
    sexo=tk.StringVar(value="Masculino") 
    rbMasculino=tk.Radiobutton(ventanaRegDoc,text="Masculino",variable=sexo,value="Masculino", bg="#800020", fg="white", font=("Times New Roman", 12)) 
    rbMasculino.grid(row=3,column=1,sticky="n") 
    rbFemenino=tk.Radiobutton(ventanaRegDoc,text="Femenino",variable=sexo,value="Femenino", bg="#800020", fg="white", font=("Times New Roman", 12)) 
    rbFemenino.grid(row=4,column=1,sticky="n") 
    #Especialidad 
    especialidadLabel=tk.Label(ventanaRegDoc,text="Especialidad:",bg="#800020", fg="white", font=("Times New Roman", 12)) 
    especialidadLabel.grid(row=5,column=0,sticky="n") 
    entryEspecialidad=tk.Entry(ventanaRegDoc, font=("Times New Roman", 12)) 
...
ventanaPrincipal.configure(bg="#800020")  # Rojo vino
#barra de menu
...
ventanaPrincipal.mainloop()  # Inicia el bucle principal de la ventana